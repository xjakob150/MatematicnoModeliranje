...
--
-- Host: localhost
-- Generation Time: May 21, 2026 at 10:32 AM
...
`id_oglasa` int(11) NOT NULL,
  `starostna_skupina` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `casovno_obdobje` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `razpolozenje_objave` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `opis_objave` mediumtext COLLATE utf8mb4_unicode_ci,
  `id_uporabnika` int(11) DEFAULT NULL,
  `id_platforme` int(11) DEFAULT NULL,
  `Dolzina_objave` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `teme_objave` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(4, '7', 'poletje', 'veselo', 'Poletje je čas za sonce, sladoled in... nepozabne digitalne dogodivščine! ☀️??\n\nV šoli programiranja Coding Giants odpiramo vrata naših BREZPLAČNIH delavnic! ? Pridruži se nam in postani pravi mojster tehnologije, medtem ko uživaš v poletnem vzdušju.\n\nKaj vse bomo ustvarjali?\n? Programirali bomo lastne svetove v #Minecraftu in #Scratchu\n? Sestavljali spletne strani s #HTML, #CSS in #JavaScriptom\n? V #Pythonu pa bomo izdelali tvoj prvi pravi ChatBot #AI klepetalnik!\n\nIzkoristi počitnice za učenje novih veščin na najbolj zabaven način! Število mest je omejeno, zato ne odlašaj s prijavo. ?‍♂️?\n\nSe vidimo v svetu kode! ?\n\n#CodingGiants #BrezplačneDelavnice #Poletje2024 #MladiProgramerji #SolaProgramiranja #DigitalneVesčine #ProgramiranjeZaOtroke', 2, 1, 'kratko', 'Brezplačne delavnice', '2026-05-12 13:24:18', 10473),
(5, '7', 'poletje', 'veselo', '☀️ Poletje je čas za sonce, sladoled in... nepozabne algoritme! ??\n\nPri Coding Giants ne počivamo – svet algoritmov raziskujemo v najboljši družbi in v najboljši volji! ? Algoritmi so kot recepti za uspeh: korak za korakom nas vodijo do lastne #Minecraft igre, čudovitih spletnih strani s #HTML in #CSS ali pa prvega #AI klepetalnika v jeziku #Python! ?\n\nNaj tvoje poletje ne bo le sproščeno, ampak tudi polno novih znanj. Programiraj z nami, osvoji digitalne svetove in se zabavaj ob reševanju logičnih izzivov, ki spreminjajo svet! ?✨ \n\nPridruži se nam in postani pravi mojster kode! ??\n\n#CodingGiantsSlovenija #ProgramiranjeZaOtroke #Algoritmi #PoletnaZabava #Scratch #Python #DigitalneVesčine #MladiProgramerji #PoletjeVPretoku #KodaJeZakon', 2, 1, 'kratko', 'Algoritmi', '2026-05-12 14:07:44', 10396),
(6, '10', 'splošno', 'motivacijsko', 'Ali si pripravljen na prihodnost, kjer pravila postavljaš TI? ?\n\nPozabi na strašne filmske scenarije o Terminatorju in uporu strojev! ? Pri Coding Giants verjamemo, da umetna inteligenca ni tu, da nas premaga, ampak da postane naše najmočnejše orodje. Namesto da bi se bali prihodnosti, se jo naučimo soustvarjati! ?✨\n\nVstopi v svet, kjer tvoja domišljija nima meja. Pri nas programiranje ni le suhoparno tipkanje, ampak prava pustolovščina:\n⛏️ Ustvarjaj in spreminjaj svetove v **Minecraftu** s pomočjo kode.\n? Oživljaj svoje junake v **Scratchu**.\n? Postavi svojo prvo spletno stran s **HTML, CSS in JavaScriptom**.\n? V **Pythonu** pa izdelaj svoj prvi pravi **AI klepetalnik**! ?\n\nNe bodi le opazovalec digitalnega sveta – postani njegov arhitekt. Razvijaj digitalne kompetence, ki ti bodo odprle vsa vrata, in se nauči, kako ukrotiti tehnologijo, preden ona ukroti tebe. ?\n\nPostani mojster kode, premagaj izzive in pokaži svetu, kaj zmoreš! Tvoja pot do digitalnega genija se začne tukaj. ??‍??‍?\n\nPridruži se nam v šoli programiranja Coding Giants in spremeni svoje sanje v vrstice kode! ??\n\n#CodingGiants #ProgramiranjeZaOtroke #UmetnaInteligenca #Minecraft #Python #Scratch #CodeWeek #PrihodnostJeTvoja #MladiProgramerji #SolaProgramiranja #DigitalneVesčine', 2, 1, 'srednje', 'Umetna inteligenca, Programiranje iger, Minecraft', '2026-05-14 23:10:02', 3529),
(7, '7', 'poletje', 'veselo', 'Sonce sije, mi pa gradimo! ☀️ Letošnje poletje v Coding Giants preživljamo v družbi Minecrafta in neverjetnih digitalnih dogodivščin! ⛏️?\n\nPridruži se nam in postani pravi mojster kode! Poleg raziskovanja Minecraft svetov bomo:\n? programirali nore igre v #Scratchu,\n? ustvarjali čisto prave spletne strani s #HTML in #CSS,\n? v #Pythonu pa zgradili svoj prvi AI klepetalnik!\n\nNaj bodo tvoje počitnice polne ustvarjalnosti, smeha in novih znanj. ? Rezerviraj svoje mesto in naj se tvoja poletna programerska pustolovščina začne! ?✨\n\n#CodingGiants #Minecraft #Poletje #Programiranje #MladiProgramerji #DigitalneVeščine #Python #Scratch #SummerVibes #SolaProgramiranja', 2, 1, 'kratko', 'Minecraft', '2026-05-14 23:10:45', 325),
(8, '7', 'poletje', 'veselo', 'Poletje je čas za nepozabne pustolovščine, mi pa ga bomo preživeli v najboljši družbi – v svetu Minecrafta! ☀️⛏️\n\nV šoli programiranja Coding Giants to poletje osvajamo digitalne svetove in spreminjamo igro v znanje! ? Pridruži se nam na nepozabnih počitnicah, kjer bomo:\n? Programirali lastne računalniške igre v #Minecraft in #Scratch.\n? Ustvarili svoj prvi #AI klepetalnik v jeziku #Python.\n? Gradili spletne strani s #HTML, #CSS in #JavaScript.\n\nNaj tvoje počitnice ne bodo le igranje, ampak pravo ustvarjanje! ? Postani mojster kode, razvijaj svoje digitalne kompetence in se ob tem neizmerno zabavaj. ✨\n\nPrijavi se zdaj in naj se tvoja poletna programerska avantura začne! ??\n\n#CodingGiants #PoletnaŠola #ProgramiranjeZaOtroke #MinecraftSlovenija #MladiProgramerji #ZabavaInZnanje #CodeWeek #SolaProgramiranja #UmetnaInteligenca', 2, 1, 'kratko', 'Minecraft', '2026-05-14 23:10:59', 375),
(9, '7', 'poletje', 'veselo', 'Sonce sije, koda pa se piše! ☀️ Tudi poleti v Coding Giants ne počivamo, ampak raziskujemo svet algoritmov na najbolj zabaven način! ??\n\nAlgoritmi so kot najboljši recepti za poletno osvežitev – brez njih ni magije v #Minecraftu ali #Scratchu! ?✨ Nauči se, kako "razmišlja" računalnik, zgradi svojo spletno stran s #HTML in #CSS ali pa ustvari svoj prvi #AI klepetalnik v #Pythonu! ??\n\nNaj bo to poletje v znamenju ustvarjalnosti in novih digitalnih dogodivščin. Pridruži se nam in sprogramiraj svojo nepozabno avanturo! ??\n\n#CodingGiants #SolaProgramiranja #Poletje #Algoritmi #DigitalneVescine #ProgramiranjeZaOtroke #Python #Minecraft #Scratch #CodingAdventure', 3, 1, 'kratko', 'Algoritmi', '2026-05-14 23:11:48', 3250),
(10, '7', 'poletje', 'veselo', '☀️ POLETJE JE TUKAJ, USTVARJALNOST PRI CODING GIANTS PA NE POZNA DOPUSTA! ?\n\nMedtem ko se sonce poigrava na gladini morja in se temperature dvigajo, mi v naših učilnicah (kjer je prijetno hladno! ❄️) ustvarjamo nepozabne digitalne spomine! Si pripravljen, da letošnje poletje ne bo le čas za sladoled, ampak tudi čas, ko postaneš pravi mojster tehnologije? ??\n\nPri Coding Giants verjamemo, da so počitnice idealna priložnost za raziskovanje novih svetov. In ne govorimo le o tistih na plaži! Letošnje poletje je v znamenju **UMETNE INTELIGENCE (AI)**, ki spreminja svet hitreje kot se taja lučka na soncu. ?✨\n\nKaj vse bomo ušpičili skupaj? Naši tečaji so kot najslajša poletna sadna kupa – polni barv, svežine in vitaminov za tvoje možgane! ?? Odgrizni košček znanja in si poglej, kaj te čaka:\n\n? **Minecraft & Scratch:** Za tiste, ki obožujete kreativnost! Ne bomo le igrali, ampak bomo programirali lastna pravila, svetove in mehanike. Postani arhitekt svoje digitalne usode! ?️?️\n\n? **Spletne strani s HTML, CSS in JavaScript:** Ustvari svojo prvo spletno stran, kjer boš objavil vse svoje poletne dogodivščine. Naj tvoj portfelj zasije v najlepših barvah poletja! ??\n\n? **Python in Umetna Inteligenca:** To je pravi "sad" našega truda! V Pythonu se bomo naučili zgraditi tvoj prvi **ChatBot AI klepetalnik**. Predstavljaj si, da ustvariš pametnega digitalnega prijatelja, ki se bo znal pogovarjati s tabo! To so pravi sadovi prihodnosti, ki jih lahko okusiš že danes. ??\n\nNaj bo tvoje poletje polno "sočnih" idej in sladkih zmag nad programskimi hrošči. Programiranje je kot nabiranje najslajših jagod – na začetku se moraš malo potruditi, ko pa osvojiš veščino, so rezultati (sadovi dela!) naravnost čudoviti! ??\n\nNe zamudi priložnosti, da se pridružiš naši ekipi mladih velikanov. Pri nas ne le tipkamo kode, ampak gradimo prihodnost, se smejimo in razvijamo digitalne kompetence, ki ti bodo odprle vsa vrata. ??\n\nPridruži se nam v svetu, kjer domišljija nima meja in kjer je vsaka vrstica kode nov korak k veliki pustolovščini. Se vidimo na najboljši poletni šoli programiranja! ??\n\n#CodingGiants #SolaProgramiranja #UmetnaInteligenca #Poletje2024 #MladiProgramerji #Python #Minecraft #Scratch #WebDev #AI #DigitalneKompetence #SadjeZnanja #PoletnaZabava', 3, 1, 'dolgo', 'Umetna inteligenca', '2026-05-14 23:12:50', 2762),
(11, '7', 'poletje', 'veselo', 'Vroče poletje, še bolj vroče kode! ? Pridruži se nam na nepozabni digitalni dogodivščini s Coding Giants! ?\n\nTo poletje prosti čas spremenimo v ustvarjanje:\n? Razvijamo legendarne igre v #Minecraft in #Scratch!\n? Gradimo čisto prave spletne strani s #HTML in #CSS!\n\nNamesto da igre samo igraš, postani njihov ustvarjalec. ? Čaka te kopica zabave, novi prijatelji in znanje, ki odpira vrata v prihodnost. ?✨\n\nVstopi v svet programiranja z nasmehom in postani pravi digitalni velikan! ?️?\n\n#CodingGiants #PoletneDelavnice #ProgramiranjeZaOtroke #MladiProgramerji #Ustvarjalnost #GameDev #WebDev #PoletnaZabava', 2, 1, 'kratko', 'Programiranje iger, Razvoj spletnih strani', '2026-05-14 23:17:46', 389),
(12, '7', 'poletje', 'veselo', 'Sonce sije, počitnice so v polnem zamahu, mi pa ustvarjamo! ☀️?\n\nTo poletje v šoli @[Coding Giants Slovenija] s pomočjo #AppInventor-ja spreminjamo tvoj pametni telefon v pravo programersko igrišče! ? Namesto da aplikacije samo uporabljaš, se nauči, kako jih samostojno zgraditi. Od zabavnih iger do uporabnih pripomočkov – meje postavlja le tvoja domišljija! ??\n\nPridruži se nam na nepozabni poletni pustolovščini, kjer skozi smeh in druženje osvajamo digitalne kompetence in svet mobilne tehnologije. Postani mojster kodiranja tudi ti! ?✨\n\n#CodingGiants #AppInventor #PoletnaŠola #ProgramiranjeZaOtroke #UstvarjamoPrihodnost #MladiProgramerji #DigitalneVeščine #PoletjeInKoda #ZabavaZTehnologijo', 2, 1, 'kratko', 'Appinventor', '2026-05-15 09:56:28', 321),
(13, '7', 'poletje', 'veselo', 'Sonce sije, koda pa se piše! ☀️? Pridruži se nam v Coding Giants na nepozabni poletni avanturi, kjer domišljija nima meja! ?\n\nTo poletje skupaj:\n? Ustvarjamo nore računalniške igre v #Minecraft in #Scratch!\n? Gradimo kul spletne strani s #HTML, #CSS in #JavaScript!\n\nIzkoristi počitnice za zabavo, druženje in osvajanje digitalnih veščin prihodnosti. Postani pravi mojster programiranja v najboljši družbi in pokaži svojo kreativnost! ?‍??‍?✨\n\nSe vidimo? Zagotovi si svoje mesto in zaplavaj v svet kode! ??\n\n#CodingGiants #ProgramiranjeZaOtroke #Poletje #GameDev #WebDev #MladiGeniji #KodaJeZabavna #solaprogramiranja', 2, 1, 'kratko', 'Programiranje iger, Razvoj spletnih strani', '2026-05-18 10:23:42', 390),
(14, '7', 'poletje', 'veselo', 'Pridružite se nam na delavnici Programiranje iger, Appinventor! ?', 2, 1, 'kratko', 'Programiranje iger, Appinventor', '2026-05-19 09:14:10', 2563),
(15, '7', 'poletje', 'veselo', '☀️ **POLETJE, SONCE IN... TVOJA PRVA MOBILNA APLIKACIJA!** ??\n\nSi želiš vroče poletne dni preživeti v najboljši družbi in postati pravi digitalni ustvarjalec? Pridruži se nam na **brezplačnih delavnicah** Coding Giants, kjer bomo skupaj osvajali svet programiranja in razvijali nove digitalne kompetence! ?✨\n\nTokrat se potopimo v zabaven svet **App Inventorja**! ?️ Namesto da aplikacije na telefonu samo uporabljaš, se nauči, kako jih zgradiš čisto sam. Sprogramiraj svojo prvo igro ali uporaben pripomoček, spoznaj nove prijatelje in naj tvoj pametni telefon postane tvoj najljubši poligon za ustvarjanje! ??\n\nPozabi na dolgčas in izkoristi poletje za nepozabno pustolovščino v svetu tehnologije. Pohiti, mesta so omejena, tvoja programerska kariera pa se začne prav tukaj! ??\n\n#CodingGiants #AppInventor #BrezplačneDelavnice #SolaProgramiranja #Poletje2025 #DigitalneKompetence #MladiProgramerji #ProgramiranjeZaOtroke #UstvarjamoPrihodnost', 2, 1, 'kratko', 'Brezplačne delavnice, Appinventor', '2026-05-19 09:16:04', 747),
(16, '7', 'poletje', 'veselo', 'Pridružite se nam na delavnici Razvoj spletnih strani, Algoritmi! ?', 2, 1, 'kratko', 'Razvoj spletnih strani, Algoritmi', '2026-05-19 09:24:36', 2730),
(17, '7', 'poletje', 'veselo', 'Pridružite se nam na delavnici Razvoj spletnih strani, Algoritmi! ?', 2, 1, 'kratko', 'Razvoj spletnih strani, Algoritmi', '2026-05-19 09:24:47', 2730),
(18, '7', 'poletje', 'veselo', 'Sonce sije, koda pa nastaja! ☀️ To poletje v šoli Coding Giants ne le uživamo v vročih dneh, ampak gradimo digitalne svetove prihodnosti! ?✨\n\nSe nam pridružiš pri ustvarjanju lastnih spletnih strani? Skupaj bomo krotili jezike #HTML, #CSS in #JavaScript ter vdihnili življenje tvojim idejam! ? Poleg tega, da bomo postali pravi mojstri spletnega razvoja, se bomo naučili tudi vse o varnosti na spletu – da bo tvoje ustvarjanje in brskanje vedno varno ter brez skrbi! ?️?\n\nPostani digitalni kreativec, osvoji nove veščine in preživi nepozabno poletje v najboljši družbi. ? Programirajmo, se zabavajmo in skupaj osvojimo splet! ??\n\n#CodingGiants #solaprogramiranja #programiranje #spletnestrani #poletje #varnostnaspletu #mladiprogramerji #ustvarjalnost #digitalnekompetence', 2, 1, 'kratko', 'Razvoj spletnih strani, Varnost na spletu', '2026-05-19 09:26:11', 498),
(19, '7', 'poletje', 'veselo', 'Pridružite se nam na delavnici Umetna inteligenca, Minecraft! 🚀', 2, 1, 'kratko', 'Umetna inteligenca, Minecraft', '2026-05-19 09:44:41', 2747),
(20, '7', 'poletje', 'veselo', 'Pridružite se nam na delavnici Razvoj spletnih strani, Varnost na spletu! 🚀', 2, 1, 'kratko', 'Razvoj spletnih strani, Varnost na spletu', '2026-05-19 09:45:24', 2670),
(21, '7', 'poletje', 'veselo', 'Sonce, morje in ... tvoja prva spletna stran! ☀️🌊 Poletje v Coding Giants je polno ustvarjalne energije, kjer vroče dni izkoristimo za grajenje digitalnih svetov! 💻✨\n\nPridruži se nam in postani pravi mojster spleta! 🚀 Nauči se, kako s #HTML, #CSS in #JavaScript zgraditi svojo unikatno stran, obenem pa odkrij vse skrivnosti za popolno **varnost na spletu**. 🛡️🔐 Poskrbi, da bo tvoj spletni kotiček ne le videti vrhunsko, ampak bo tudi varen pred vsemi digitalnimi nepridipravi!\n\nIzkoristi počitnice za nove veščine, kul projekte in nepozabno poletno vzdušje. Programiraj svojo prihodnost z nami! 🔥💻\n\n#CodingGiants #SpletneStrani #VarnostNaSpletu #MladiProgramerji #PoletnaZabava #Programiranje #WebDev #SlovenijaTipka #DigitalneKompetence', 2, 1, 'kratko', 'Razvoj spletnih strani, Varnost na spletu', '2026-05-19 09:45:49', 309),
(22, '7', 'poletje', 'veselo', 'Sonce sije, koda pa »teče«! ☀️💻 To poletje v šoli Coding Giants premagujemo vročino z najbolj kul algoritmi! 🍦🚀\n\nAli si vedel, da so algoritmi kot popoln recept za najboljši poletni sladoled? 🍧 Skupaj bomo s pomočjo logike in kreativnosti:\n🎮 programirali nepozabne pustolovščine v #Minecraft in #Scratch,\n🌐 gradili sodobne spletne strani s #HTML, #CSS in #JavaScript,\n🤖 ter v #Pythonu ustvarili svoj prvi #AI klepetalnik!\n\nNaj bodo tvoje počitnice polne digitalnih zmag in novih prijateljstev. 🌊 Postani mojster prihodnosti in pokaži, kaj zmoreš! 🌟 \n\n#CodingGiants #SolaProgramiranja #Algoritmi #Poletje2025 #MladiProgramerji #KodaJeZakon #DigitalneVesčine #ProgramiranjeZaOtroke #Python #MinecraftProgramming', 2, 1, 'kratko', 'Algoritmi', '2026-05-19 09:52:37', 336),
(23, '7', 'poletje', 'veselo', '☀️ POLETJE, SONCE IN KODA! 💻✨\n\nSi pripravljen na najboljšo poletno pustolovščino? V šoli programiranja Coding Giants te vabimo na BREZPLAČNE delavnice, kjer bomo skupaj osvajali digitalne svetove! 🚀\n\nMedtem ko uživamo v poletnih dneh, se bomo naučili:\n🎮 Programirati računalniške igre v #Minecraft in #Scratch.\n🌐 Ustvarjati spletne strani s #HTML, #CSS in #JavaScript.\n🤖 Izdelati svoj prvi #Python AI klepetalnik!\n\nPosebno pozornost pa bomo namenili tudi VARNOSTI NA SPLETU 🛡️, da bo tvoje raziskovanje digitalnega sveta vedno varno in zabavno. 🍦🌊\n\nPridi, programiraj z nami in postani pravi tehnološki mojster! Število mest je omejeno, zato pohiti! 🏃‍♂️💨\n\n#CodingGiants #BrezplacneDelavnice #VarnostNaSpletu #ProgramiranjeZaOtroke #Poletje2025 #AI #Python #Minecraft #SolaProgramiranja #DigitalneVesčine', 2, 1, 'kratko', 'Brezplačne delavnice, Varnost na spletu', '2026-05-19 10:06:21', 586),
(24, '7', 'poletje', 'veselo', 'Iščeš najboljšo poletno pustolovščino? ☀️🎮 Pridruži se nam v svetu Coding Giants, kjer poletje postane prava digitalna dogodivščina! 🚀\n\nTvoj najljubši Minecraft te čaka – namesto da ga samo igraš, se nauči, kako ga programirati! 🧱💻 Na naših **brezplačnih delavnicah** bomo v sproščenem in zabavnem vzdušju odkrivali skrivnosti koda, ustvarjali lastne svetove in se naučili, kako tehnologija zares deluje. 🌈✨\n\nNe zamudi priložnosti, da to poletje postaneš pravi mojster programiranja! 🛠️💡\n\n👉 Prijavi se čim prej in si zagotovi svoje mesto v naši digitalni ekipi! Se vidimo pri kodiranju! 🥳👩‍💻👨‍💻\n\n#CodingGiants #Programiranje #Minecraft #Poletje #BrezplacneDelavnice #MladiProgramerji #KodiranjeJeZabavno', 2, 1, 'kratko', 'Minecraft, Brezplačne delavnice', '2026-05-19 10:22:40', 570),
(25, '7', 'poletje', 'veselo', 'Poletje kliče po dogodivščinah, zakaj pa jih ne bi ustvarili kar sami? ☀️🚀\n\nPri Coding Giants smo pripravili nepozabne poletne počitnice, kjer koda postane tvoje najmočnejše orodje! Si želiš zgraditi svoj svet v #Minecraftu ali pa razviti lastno mobilno aplikacijo v #AppInventor? 🎮📱 Zdaj je pravi čas, da se nam pridružiš, osvojiš digitalne veščine in postaneš pravi mojster programiranja!\n\nPridruži se nam, zabavaj se s prijatelji in ustvari nekaj čisto svojega. Tvoja poletna pustolovščina se začne tukaj! 💻✨\n\nPrijave so že odprte – ne zamudi najboljše poletne izkušnje! 🚀\n\n#CodingGiants #Programiranje #Poletje #Minecraft #AppInventor #MladiProgramerji #Ustvarjanje #Zabava', 2, 1, 'kratko', 'Minecraft, Appinventor', '2026-05-19 10:36:14', 473),
(26, '7', 'poletje', 'veselo', 'Iščeš najboljši poletni plan? ☀️ Pridruži se nam v Coding Giants, kjer poletne dni spreminjamo v pravo programersko pustolovščino! 🚀\n\n🎮 **Zgradi svoj svet v Minecraftu:** Postani mojster gradnje in skozi igro spoznaj osnove algoritmov.\n🛡️ **Bodi varen na spletu:** Nauči se, kako pametno in varno krmariti po digitalnem svetu.\n💡 **Ustvarjaj:** Programiranje ni samo koda, je tvoja supermoč za ustvarjanje novih svetov!\n\nNaj bo poletje čas, ko ne samo igraš igre, ampak jih začneš ustvarjati! 💻✨ \n\nPrijavi se na naše poletne delavnice in postani del Coding Giants ekipe. Čakamo nate! 👇\n\n#CodingGiants #ProgramiranjeZaOtroke #Minecraft #Poletje #VarnostNaSpletu #Kodiranje #MladiProgramerji', 2, 1, 'kratko', 'Minecraft, Varnost na spletu, Algoritmi', '2026-05-19 10:45:48', 273),
(27, '7', 'poletje', 'veselo', 'Poletje je tu, šola je končana, čas je za pravo pustolovščino! ☀️🚀\n\nSi želiš, da bi tvoje poletne počitnice postale nepozabne? Pridruži se nam v Coding Giants, kjer bomo skupaj osvajali svet programiranja na najbolj zabaven način – skozi igro Minecraft! 🧱💎\n\nPripravili smo **BREZPLAČNE delavnice**, kjer boš odkrival skrivnosti ustvarjanja digitalnih svetov, se naučil logike programiranja in postal pravi mojster v Minecraftu! 🎮💻\n\nNe zamudi priložnosti, da to poletje nadgradiš svoje digitalne veščine, spoznaš nove prijatelje in ustvariš svojo lastno igro. 🌟\n\n👉 Prijavi se čim prej in si zagotovi svoje mesto v naši poletni šoli programiranja! Čakamo nate! 🚀✨\n\n#CodingGiants #Programiranje #Minecraft #Pocitnice #BrezplacneDelavnice #MladiProgramerji #PoletjeZnanja', 2, 1, 'kratko', 'Minecraft, Brezplačne delavnice', '2026-05-19 11:31:50', 387);
...
(2, '4', '1', '2', 'scrypt:32768:8:1$fLya39K0pNPyIM1X$29af71f47e7265bedd5dc63f9f7130798c9354c7276f955f9db1b69f8e29370fdd4fe5e8ffc11416295a889f048d8b9752fc54a7554d59e3b309dfbc33b7f3d2'),
(3, 'Jakob', 'Smrlek', '1@1', 'scrypt:32768:8:1$VJ056bcqJGw90jvi$b0c1b243aa6a4d3a20799d6909cf0ba919bce432c43262184ef15b0fcb86aabb70187138f2d678ddd820a35c44c56ad6a3feb74574a904ec896ac549d840cb54');
...
--
ALTER TABLE `generiranje_oglasa`
MODIFY `id_oglasa` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
...
GRANT ALL PRIVILEGES ON matematicnomodeliranje.* TO 'appuser'@'%';
